...
%%vincolo 3
%%Materia 2 puo iniziare solo dopo che Materia1 ha fatto almeno 4 ore
:-  propedeucita(Materia1, Materia2), lezione(Materia2, Settimana, Giorno, Ora), { lezione(Materia1, Settimana1, Giorno1, Ora1) : Settimana1 * 100 + Giorno1 * 10 + Ora1 <= Settimana * 100 + Giorno * 10 + Ora} < 4.
